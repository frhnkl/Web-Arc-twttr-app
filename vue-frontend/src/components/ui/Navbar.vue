<template>
  <div class="bg-blue-500 flex justify-around h-10 text-white">
    <h3 class="self-center text-2xl font-bold">Twttr</h3>
    <ul class="flex justify-evenly items-center">
      ...
      <li class="mr-4">
        <a :href="urlAdmin" class="hover:border-b-2 border-white">Admin</a>
      </li>
      <li>
